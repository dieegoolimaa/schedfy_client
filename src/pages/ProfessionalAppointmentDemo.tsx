...
export default function ProfessionalAppointmentDemo() {
  ...
  const handleStatusChange = async (appointmentId: string, newStatus: Appointment['status']) => {
    ...
    toast.success(`Agendamento ${newStatus === 'completed' ? 'finalizado' : 'atualizado'}!`);
  };
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-sm text-gray-600 space-y-2 mb-4">
              <p>🎯 <strong>Objetivo:</strong> Testar o pop-up de finalização de serviço</p>
              <p>📋 <strong>Cenário:</strong> Agendamento confirmado pronto para ser finalizado</p>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-2 text-green-800 dark:text-green-200">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    O agendamento foi concluído com sucesso. Os dados foram processados e estão prontos para integração.
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        <Card className="border-blue-200 bg-blue-50 dark:bg-blue-950">
          <CardContent className="p-4">
            ...
            <ol className="text-sm text-blue-700 dark:text-blue-300 space-y-1 list-decimal list-inside">
              <li>Clique no botão <strong>"Finalizar"</strong> no card do agendamento</li>
              ...
              <li>Clique em <strong>"Finalizar Serviço"</strong></li>
            </ol>
          </CardContent>
        </Card>
      </div>
